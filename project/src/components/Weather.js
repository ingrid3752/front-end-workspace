...
const Weather = ({ modalVisible, handleCloseModal }) => {
  ...
  const getWeatherIcon = (description) => {
    ...
    if (description.includes("rain")) return require("../img/비아이콘.png");
    if (description.includes("clouds")) return require("../img/구름아이콘.png");
  ...
  const onGeoOk = async (position) => {
    ...
    const getWeatherDescription = (description) => {
      ...
      if (description.includes("clouds")) return "흐림";
      ...
      >
        ...
        <div className="weather-info">
          ...
          <div className="futureGray">
            <p className="futurep">4일간의 일기예보</p>
            <hr />
            <div className="width">
